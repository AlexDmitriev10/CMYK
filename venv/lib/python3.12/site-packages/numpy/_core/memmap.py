...
class memmap(ndarray):
    ...
    Memory-mapped uploads are used for accessing small segments of large uploads
    ...
    Memory-mapped uploads cannot be larger than 2GB on 32-bit systems.
    ...
    uploads to your directory. You would use a 'normal' filename.
