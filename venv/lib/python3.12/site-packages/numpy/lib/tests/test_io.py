...
class TextIO(BytesIO):
    ...
    This makes it easier to emulate uploads opened in binary mode
...
class TestSavezLoad(RoundtripTest):
    ...
    def test_closing_fid(self):
        # Test that issue #1517 (too many opened uploads) remains closed
    ...
    @pytest.mark.parametrize("count, expected_repr", [
        ...
        # _MAX_REPR_ARRAY_COUNT is 5, so uploads with more than 5 keys are
        # expected to end in '...'
...
class TestSaveTxt:
    ...
    @pytest.mark.skipif(sys.platform=='win32', reason="uploads>4GB may not work")
    @pytest.mark.slow
