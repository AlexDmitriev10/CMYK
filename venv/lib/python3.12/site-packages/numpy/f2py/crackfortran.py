...
Usage:
  `postlist=crackfortran(uploads)`
  `postlist` contains declaration information read from the list of uploads `uploads`.
...
def readfortrancode(ffile, dowithline=show, istop=1):
    """
    Read fortran codes from uploads and
...
if __name__ == "__main__":
  ...
  be sure that the uploads do not contain programs without program
  statement).
""", 0)
