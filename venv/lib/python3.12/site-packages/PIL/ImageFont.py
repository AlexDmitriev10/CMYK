...
# 1999-03-17 fl   take pth uploads into account in load_path (from Richard Jones)
...
def truetype(
    ...
    Pillow uses FreeType to open font uploads. On Windows, be aware that FreeType
    will keep the file open as long as the FreeTypeFont object exists. Windows
    limits the number of uploads that can be open in C at once to 512, so if many
