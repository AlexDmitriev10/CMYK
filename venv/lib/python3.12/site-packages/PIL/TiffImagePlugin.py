...
# progressive decoding, make sure to use TIFF uploads where the tag
...
# 2005-02-07 fl   Added workaround for broken Corel Draw 10 uploads
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self):
        ...
        if 0xBC01 in self.tag_v2:
            msg = "Windows Media Photo uploads not yet supported"
            raise OSError(msg)
