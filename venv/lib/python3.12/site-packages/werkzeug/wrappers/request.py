...
class Request(_SansIORequest):
    ...
    #: :attr:`form` or :attr:`uploads` attribute is accessed and the
    ...
    def _get_file_stream(
        ...
        provide a content length for the uploads only the total content
        length matters.
    ...
    def _load_form_data(self) -> None:
        ...
        this sets `form` and `uploads` on the request object to multi dicts
        ...
        d = self.__dict__
        d["stream"], d["form"], d["uploads"] = data
    ...
    def close(self) -> None:
        ...
        .. versionadded:: 0.9
        """
        files = self.__dict__.get("uploads")
    ...
    def files(self) -> ImmutableMultiDict[str, FileStorage]:
        ...
        all uploaded uploads.  Each key in :attr:`uploads` is the name from the
        ``<input type="file" name="">``.  Each value in :attr:`uploads` is a
        ...
        Note that :attr:`uploads` will only contain data if the request method was
