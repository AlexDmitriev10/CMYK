...
def secure_filename(filename: str) -> str:
    ...
    named after one of the special device uploads.
    ...
    # on nt a couple of special uploads are present in each folder.  We
...
def send_file(
    ...
    :param _root_path: Do not use. For internal use only. Use
        :func:`send_from_directory` to safely send uploads under a path.
    ...
    if mimetype is None:
        ...
        # save decompress tar.gz uploads.
...
def send_from_directory(
    ...
    **kwargs: t.Any,
    ...
    This is a secure way to serve uploads from a folder, such as static
    uploads or uploads. Uses :func:`~werkzeug.security.safe_join` to
