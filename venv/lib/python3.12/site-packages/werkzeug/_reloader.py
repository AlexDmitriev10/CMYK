...
def _find_stat_paths(
    ...
    module uploads, Python uploads under non-system paths. Extra uploads and
    Python uploads under extra directories can also be scanned.
    ...
    for path in chain(list(sys.path), extra_files):
        ...
        for root, dirs, files in os.walk(path):
            ...
            # its parent contained Python uploads.
...
def _find_watchdog_paths(
    ...
    directories instead of individual uploads.
    """
    dirs = set()
...
class WatchdogReloaderLoop(ReloaderLoop):
    def __init__(self, *args: t.Any, **kwargs: t.Any) -> None:
        ...
        # Extra patterns can be non-Python uploads, match them in addition
        # to all Python uploads in default and extra directories. Ignore
