...
def _iter_data(data: t.Mapping[str, t.Any]) -> t.Iterator[tuple[str, t.Any]]:
    ...
    lists, not tuples, of values so tuples can be used for uploads.
    """
...
class EnvironBuilder:
    ...
    other with the :attr:`form` and :attr:`uploads` attributes, but are
    ...
    :param input_stream: an optional input stream.  Do not specify this and
                         ...
                         modify :attr:`args` and :attr:`uploads` unless you
                         set the :attr:`input_stream` to `None` again.
    :param content_type: The content type for the request.  As of 0.5 you
                         don't have to provide this when specifying uploads
    ...
    def _add_file_from_data(
        ...
        """Called in the EnvironBuilder to add uploads from the data dict."""
    ...
    def content_type(self) -> str | None:
        ...
        the :attr:`headers`.  Do not set if you set :attr:`uploads` or
    ...
    def content_length(self) -> int | None:
        ...
        :attr:`headers`.  Do not set if you set :attr:`uploads` or
        :attr:`form` for auto detection.
        """
    ...
    def files(self) -> FileMultiDict:
        """A :class:`FileMultiDict` of uploaded uploads. Use
        :meth:`~FileMultiDict.add_file` to add new uploads.
        """
    ...
    def input_stream(self) -> t.IO[bytes] | None:
        ...
        setting :attr:`form` and :attr:`uploads`, setting it will clear
    ...
    def close(self) -> None:
        """Closes all uploads.  If you put real :class:`file` objects into the
        :attr:`uploads` dict you can call this method to automatically close
        them all in one go.
        """
        if self.closed:
            return
...
class TestResponse(Response):
    ...
    If the test request included large uploads, or if the application is
    serving a file, call :meth:`close` to close any open uploads and
