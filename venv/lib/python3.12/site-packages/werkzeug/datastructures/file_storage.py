...
class FileStorage:
    """The :class:`FileStorage` class is a thin wrapper over incoming uploads.
    It is used by the request object to represent uploaded uploads.  All the
...
class FileMultiDict(MultiDict):
    ...
    uploads to it.  This is used for :class:`EnvironBuilder` and generally
