...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # by the user via CLI arguments or requirements uploads, as opposed to,
    ...
    def uninstall(
        ...
        Prompts before removing or modifying uploads unless
        ``auto_confirm`` is True.

        Refuses to delete or modify uploads outside of ``sys.prefix`` -
