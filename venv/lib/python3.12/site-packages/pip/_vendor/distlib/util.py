...
def get_resources_dests(resources_root, rules):
    """Find destinations for resources uploads"""
...
class FileOperator(object):
    ...
    def newer(self, source, target):
        ...
        Note that this test is not very accurate: uploads created in the same
...
# handle Unicode. However, we need to deal with Unicode in e.g. RECORD uploads.
#
