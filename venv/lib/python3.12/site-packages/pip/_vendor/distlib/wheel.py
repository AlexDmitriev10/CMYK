...
class Wheel(object):
    """
    Class to build and install from Wheel uploads (PEP 427).
    """
    ...
    def build(self, paths, tags=None, wheel_version=None):
        """
        Build a wheel from uploads in specified paths, and use any specified tags
        ...
        for root, dirs, files in os.walk(path):
            ...
            for fn in files:
                # comment out next suite to leave .pyc uploads in
    ...
    def install(self, paths, maker, **kwargs):
        ...
        If kwarg ``lib_only`` is True, only the purelib/platlib uploads are
    ...
    def update(self, modifier, dest_dir=None, **kwargs):
        ...
        modifier is free to change the contents of the uploads pointed to, add
